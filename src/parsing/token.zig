...
fn extractWord(line_lex: *LineLex, env: *std.process.Environ.Map, allocator: std.mem.Allocator) ![]const u8 {
...
pub fn lex(allocator: std.mem.Allocator, line: []const u8, env: *std.process.Environ.Map) ![]Token {
